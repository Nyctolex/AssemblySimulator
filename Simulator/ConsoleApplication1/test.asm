...
sw $ra, $zero, $sp, 0 #pushing $ra to stack ,if n==k return 1;
add $sp, $imm, $sp, -4 #allocating memory in the stack
sw $a0, $zero, $sp, 0 #pushing $a0 to stack ,if n==k return 1;
add $sp, $imm, $sp, -4 #allocating memory in the stack
sw $a1, $zero, $sp, 0 #pushing $a1 to stack ,if n==k return 1;
...
add $sp, $imm, $sp, 4 #freeing memory in stack
lw $ra, $zero, $sp, 0 #poping $ra from stack, $a1 = k again
add $sp, $imm, $sp, 4 #freeing memory in stack
add $sp, $imm, $sp, -4 #allocating memory in the stack
...
add $sp, $imm, $sp, -4 #allocating memory in the stack
sw $ra, $zero, $sp, 0 #pushing $ra to stack ,$a1 = k again
sub $a0, $a0, $imm, 1 # $a0 = n-1
jal $ra, $imm, $zero, BINOM
